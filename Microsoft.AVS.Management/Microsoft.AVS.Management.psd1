...
@{
    ...
    FunctionsToExport = @("Set-AvsVMStoragePolicy", "New-AvsLDAPIdentitySource", "New-AvsLDAPSIdentitySource", "Get-ExternalIdentitySources", "Remove-ExternalIdentitySources", "Add-GroupToCloudAdmins", "Remove-GroupFromCloudAdmins")
