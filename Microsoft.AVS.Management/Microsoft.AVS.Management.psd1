...
@{
    ...
    FunctionsToExport = @("Set-AvsVMStoragePolicy", "New-AvsLDAPIdentitySource", "New-AvsLDAPSIdentitySource", "Add-GroupToCloudAdmins", "Remove-GroupFromCloudAdmins", "New-AvsDrsElevationRule", "Set-AvsDrsVMClusterGroup", "Set-AvsDrsVMHostClusterGroup", "Set-AvsDrsElevationRule")
